  ...
  <div :class="[
    ...
    <div class="max-w-md mx-auto px-4 py-6 pb-24 overflow-y-auto max-h-screen" ref="scrollContainer"
      ...
      <header class="mb-8 relative">
        ...
        <div class="relative z-10 flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h1 class="text-2xl font-bold"><b>Roth</b> - Guest List</h1>
      ...
      <div :class="[
        ...
        <div class="text-4xl">
          <router-link to="/huor" class="text-4xl">
            👰‍♀️
          </router-link>
        </div>
      </div>
        ...
        <div class="space-y-4">
          <div>
            ...
            <input ref="nameInput" v-model="newGuestName" type="text" placeholder="Enter full name" :class="[
              ...
              isDarkMode
                ? 'bg-gray-800 border-gray-700 focus:ring-pink-500'
                : 'bg-white border-gray-200 focus:ring-pink-400'
